...
if (isset($_POST['login'])) {
    ...
    // mengambil data
    $result = mysqli_query($aaaa, "SELECT * FROM admin WHERE username = '$username'");
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            <a class="navbar-brand" href="index.php">UNIPDU</a>
    ...
    <div class="container">
        <div class="row my-5">
            <div class="col-md-6 text-center login" style="background-image: url('img/bg/geraha.jpg');">
